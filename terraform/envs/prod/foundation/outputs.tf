...
output "addon_versions" {
  description = "Resolved version currently installed per EKS addon (key = addon name). Capture into addon_versions to pin, once stable, to make plans deterministic."
